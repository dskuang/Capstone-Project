...
(function() { this.JST || (this.JST = {}); this.JST["blogShow"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  blog.escape('title') ,'</h1>\n\n<ul class="posts">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["nav"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="navbar navbar-default">\n  <div class="container-fluid">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class="navbar-header">\n\n\n        <span class="sr-only">Toggle navigation</span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </button>\n      <a class="navbar-brand" href="#">Brand</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n      <ul class="nav navbar-nav">\n        <li class="dropdown">\n          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <span class="caret"></span></a>\n          <ul class="dropdown-menu">\n            <li><a href="#">Action</a></li>\n            <li><a href="#">Another action</a></li>\n            <li><a href="#">Something else here</a></li>\n            <li role="separator" class="divider"></li>\n            <li><a href="#">Separated link</a></li>\n            <li role="separator" class="divider"></li>\n            <li><a href="#">One more separated link</a></li>\n          </ul>\n        </li>\n      </ul>\n\n      <form class="navbar-form navbar-left" role="search">\n        <div class="form-group">\n          <input type="text" class="search-input form-control" name="query" placeholder="Search" value="" autocomplete="off">\n          <ul class="search-ac">\n\n          </ul>\n        </div>\n      </form>\n\n\n\n      <ul class="nav navbar-nav navbar-right">\n\n          <div class="home-icon"></div>\n          <div class="explore-icon"></div>\n        <li class="dropdown log-icon">\n          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <span class="caret"></span></a>\n          <ul class="dropdown-menu">\n            <li><a rel="nofollow" data-method="delete" href="/session">Logout</a></li>\n            <li><a href="#">Another action</a></li>\n            <li><a href="#">Something else here</a></li>\n            <li role="separator" class="divider"></li>\n            <li><a href="#">Separated link</a></li>\n          </ul>\n        </li>\n      </ul>\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["newsFeed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<script type="text/javascript" src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>\n<div class="post-nav">\n  <div class= "post-text-image ball text-post button-post" data-attr="Text"></div>\n  <div class="post-quote-image ball quote-post button-post" data-attr="Quote"></div>\n\n  <div class="post-link-image ball link-post button-post" data-attr="Link"></div>\n  <div class="post-picture-image ball picture-post button-post" data-attr="Image"></div>\n\n  <div class="post-song-image ball song-post button-post" data-attr="Song"></div>\n  <div class="post-video-image ball video-post button-post" data-attr="Video"></div>\n\n<div id="rightSideContent"></div>\n</div>\n  <div id="leftSideBar"></div>\n\n\n\n<div class="parent-form">\n  <div class= "new-form-view">\n  </div>\n\n  <div class="newsfeed-posts">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["postIndex"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<div class="inner-post-frame">\n\n  <div class="posts-index">\n\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["postNew"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="shade">\n\n    <form class="new-post">\n    <input class="form-control"\n              type = "hidden"\n              name=\'post[attr]\'\n              value= "',  post.escape("attr") ,'" >\n    '); if (post.get("attr") === "Text") {; __p.push('\n      <h1>New Text Post</h1>\n      <label for=\'title\'></label><br>\n        <input class="header-input form-control"\n               type=\'text\'\n               name=\'post[title]\'\n               id=\'title\'\n               value=\'\'\n               placeholder="Title"><br>\n      <label for=\'body\'></label><br>\n        <textarea class="body-input form-control"\n              type=\'text\'\n              name=\'post[body]\'\n              id=\'title\'\n              value=\'\'\n              placeholder="Body"></textarea><br>\n        <input class="form-control tag-input"\n              type=\'text\'\n              name=\'post[tag]\'\n              id=\'tag\'\n              placeholder="Tags"\n              value=\'\'><br>\n      <button class="submit-post">Submit</button>\n      <button class="cancel-post">Cancel</button>\n\n\n    ');  } else if (post.get("attr") === "Quote") { ; __p.push('\n      <h1>New Quote Post</h1>\n      <label for=\'quotetitle\'></label><br>\n        <input class="form-control header-input"\n               type=\'text\'\n               name=\'post[quotetitle]\'\n               id=\'quotetitle\'\n               placeholder="Quote"\n               value=\'\'><br>\n      <label for=\'quotesource\'></label><br>\n        <input class="form-control body-input"\n              type=\'text\'\n              name=\'post[quotesource]\'\n              id=\'quotesource\'\n              placeholder="-source"\n              value=\'\'><br>\n        <input class="form-control tag-input"\n              type=\'text\'\n              name=\'post[tag]\'\n              id=\'tag\'\n              placeholder="Tags"\n              value=\'\'><br>\n      <button class="submit-post">Submit</button>\n      <button class="cancel-post">Cancel</button>\n\n    ');  } else if (post.get("attr") === "Link") { ; __p.push('\n      <h1>New Link</h1>\n      <label for=\'linkurl\'></label><br>\n        <input class="form-control header-input"\n               type=\'text\'\n               name=\'post[linkurl]\'\n               id=\'linkurl\'\n               value=\'\'\n               placeholder="Url"><br>\n      <label for=\'linkbody\'></label><br>\n        <textarea class="form-control body-input"\n              type=\'text\'\n              name=\'post[linkbody]\'\n              id=\'linkbody\'\n              value=\'\'\n              placeholder="Description"></textarea><br>\n        <input class="form-control tag-input"\n              type=\'text\'\n              name=\'post[tag]\'\n              id=\'tag\'\n              placeholder="Tags"\n              value=\'\'><br>\n      <button class="submit-post">Submit</button>\n      <button class="cancel-post">Cancel</button>\n    ');  } else if (post.get("attr") === "Image") { ; __p.push('\n\n      <h1>New Image</h1>\n      <button data-attr="Image"\n              class="filepicker-button btn btn-primary"></button>\n      <input class= "image-input form-control"\n              name=\'post[imageUrl]\'\n              type=\'text\'\n              id = \'imageurl\' value=\'\'\n              placeholder="Image Url">\n             <br>\n      <label for=\'imagebody\'></label><br>\n        <textarea class="form-control body-input"\n              type=\'text\'\n              name=\'post[imagebody]\'\n              id=\'imagebody\'\n              value=\'\'\n              placeholder="Description"></textarea><br>\n        <input class="form-control tag-input"\n              type=\'text\'\n              name=\'post[tag]\'\n              id=\'tag\'\n              placeholder="Tags"\n              value=\'\'><br>\n      <button class="submit-post">Submit</button>\n      <button class="cancel-post">Cancel</button>\n\n      ');  } else if (post.get("attr") === "Song") { ; __p.push('\n\n          <h1>New Song</h1>\n          <button data-attr= "Song"\n                  class="filepicker-button btn btn-primary"></button>\n          <input class= "song-input form-control"\n                  name=\'post[songUrl]\'\n                  type=\'text\'\n                  id = \'songurl\' value=\'\'\n                  placeholder="Song Url">\n                   <br>\n          <label for=\'songbody\'></label><br>\n          <textarea class="form-control body-input"\n                type=\'text\'\n                name=\'post[songbody]\'\n                id=\'songbody\'\n                value=\'\'\n                placeholder="Description"></textarea><br>\n          <input class="form-control tag-input"\n                type=\'text\'\n                name=\'post[tag]\'\n                id=\'tag\'\n                placeholder="Tags"\n                value=\'\'><br>\n        <button class="submit-post">Submit</button>\n        <button class="cancel-post">Cancel</button>\n    ');  } else if (post.get("attr") === "Video") { ; __p.push('\n\n        <h1>New Video</h1>\n        <button data-attr= "Video"\n                class="filepicker-button btn btn-primary"></button>\n        <input class= "video-input form-control"\n                name=\'post[videoUrl]\'\n                type=\'text\'\n                id = \'videourl\' value=\'\'\n                placeholder="Video Url">\n                 <br>\n        <label for=\'videobody\'></label><br>\n        <textarea class="form-control body-input"\n              type=\'text\'\n              name=\'post[videobody]\'\n              id=\'videobody\'\n              value=\'\'\n              placeholder="Description"></textarea><br>\n        <input class="form-control tag-input"\n              type=\'text\'\n              name=\'post[tag]\'\n              id=\'tag\'\n              placeholder="Tags"\n              value=\'\'><br>\n      <button class="submit-post">Submit</button>\n      <button class="cancel-post">Cancel</button>\n    ');  } ; __p.push('\n\n</form>\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["postShow"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n');  if (post.get("follow_relation_id") !== null) { ; __p.push('\n    ');  var followState = "unFollow"; ; __p.push('\n  ');  } else { ; __p.push('\n    ');  var followState = "Follow"; ; __p.push('\n  ');  } ; __p.push('\n\n  ');  if (post.get("like_relation_id") !== null) { ; __p.push('\n    ');  var likeState = "unLike"; ; __p.push('\n\n  ');  } else { ; __p.push('\n    ');  var likeState = "Like"; ; __p.push('\n  ');  } ; __p.push('\n\n<div class= "post-item-border">\n\n  <div class=\'post-header\'>\n    ',  post.escape("username") ,'\n      <div class="home-icon"></div>\n      <button class="follow-button">',  followState ,'</button>\n    <p class="post-text-header">\n      ');  if (post.get("attr") === "Text") {; __p.push('\n        ',  post.escape("title") ,'\n      ');  } else if (post.get("attr") === "Quote") { ; __p.push('\n        ',  post.escape("quotetitle") ,'\n      ');  } else if(post.get("attr") === "Link") { ; __p.push('\n        ',  post.escape("linkurl") ,'\n\n    </p>\n    <div>\n      ');  } else if(post.get("attr") === "Image") { ; __p.push('\n        <img class = "index-post-image" src="',  post.get("imageUrl") ,'">\n      ');  } else if(post.get("attr") === "Song") { ; __p.push('\n        <audio class= "audio-post"\n          src="',  post.get("songUrl") ,'" controls></audio>\n      ');  } else if(post.get("attr") === "Video") { ; __p.push('\n        <video class= "video-post"\n          src="',  post.get("videoUrl") ,'" controls></video>\n      ');  } ; __p.push('\n    </div>\n\n  </div>\n\n  <div class="post-body">\n    <p class="post-text-body">\n      ');  if (post.get("attr") === "Text") {; __p.push('\n        ',  post.escape("body") ,'\n      ');  } else if (post.get("attr") === "Quote") { ; __p.push('\n        ',  post.escape("quotesource") ,'\n      ');  } else if(post.get("attr") === "Link") { ; __p.push('\n        ',  post.escape("linkbody") ,'\n      ');  } else if(post.get("attr") === "Image") { ; __p.push('\n        ',  post.escape("imagebody") ,'\n      ');  } else if(post.get("attr") === "Song") { ; __p.push('\n        ',  post.escape("songbody") ,'\n      ');  } ; __p.push('\n    </p>\n  </div>\n\n  <div class="tag-container">\n    ');  post.tags().forEach(function(tag) { ; __p.push('\n      ',  tag.escape("label") ,'\n    ');  }) ; __p.push('\n    ');  var notetext = post.notes().length === 1 ? "Note" : "Notes" ; __p.push('\n    <p>', post.notes().length,' ', notetext,' <p>\n\n    <ul class="notes-ul">\n      ');  post.notes().forEach(function(note) { ; __p.push('\n        <!-- <li class="notes-li">',  note.escape("note_text") ,'</li> -->\n      ');  }) ; __p.push('\n    <ul>\n\n    <div class="bottom-right-container">\n      <div class="reblog-image" data-post-id="', post.id,'"></div>\n      <button class="btn btn-primary like-button">',  likeState ,'</button>\n    </div>\n  </div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["trending"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>Recommended Blogs</p>\n');  blogs.each(function(blog) { ; __p.push('\n<p><a href="#/blogs/',  blog.id ,'"> </a> \n\n  ', blog.escape("title"),'\n  <br>\n  ', blog.escape("username"),'\n</p>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
...
Tumblr.Models.Tag = Backbone.Model.extend({
  urlRoot: "/api/tags"

});
Tumblr.Models.Tagging = Backbone.Model.extend({
